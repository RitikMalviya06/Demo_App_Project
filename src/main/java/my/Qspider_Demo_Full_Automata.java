...
public class Qspider_Demo_Full_Automata {
	public static void main(String[] args) throws InterruptedException, AWTException, IOException {
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//input[@id='sat1'and(@value='Yes')]"));
		Thread.sleep(2000);
		driver.findElement(By.xpath("//button[@id='btn40'and(text()='Submit')]")).click();
